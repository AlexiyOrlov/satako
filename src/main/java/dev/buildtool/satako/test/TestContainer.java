...
public class TestContainer extends Container2 {
    public TestContainer(int i, Inventory playerInventory) {
        ...
        addSlot(new ItemHandlerDisplaySlot(itemHandler, 0, 0, 0).setColor(new IntegerColor(0xff4f6a7b)).setTooltip(Component.literal("Tooltip line 1")));
        addSlot(new ItemHandlerSlot(itemHandler, 1, 18, 0).setColor(new IntegerColor(0xff4f6a7b)).setTooltip(Component.literal("Tooltip line 1")));
