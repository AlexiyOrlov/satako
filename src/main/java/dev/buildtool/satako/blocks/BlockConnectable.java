...
public abstract class BlockConnectable extends SixWayBlock {
    ...
    @Override
    public BlockState updateShape(BlockState blockState, Direction direction, BlockState state, IWorld world, BlockPos blockPos, BlockPos pos) {
        return blockState.setValue(PROPERTY_BY_DIRECTION.get(direction), state.getBlock() == this);
    }
}
